  ...
  <div class="col-md-5 mb-4">
    <div id="affiliation">
      ...
      {% for item in site.data.info.affiliation %}
        <p><i style="width: 1.5em;" class="fa fa-university" aria-hidden="true"></i><a href="http://www.snu.ac.kr/" target="_blank" >대전대학교</a> {{item.school }}<BR>
    ...
    <div id="map" class="mb-3">
      ...
      {% if site.data.info.address.building == "대전대학교" %}
        <!-- * 카카오맵 - 지도퍼가기 -->
        <div id="daumRoughmapContainer1774496364308" class="root_daum_roughmap root_daum_roughmap_landing shadow-dark mx-auto"></div>
          <script charset="UTF-8">
          	new daum.roughmap.Lander({
          		"timestamp" : "1774495985374",
          		"key" : "jyvk36cp9qd",
    ...
    <div id="address" class="mb-3">
      {% if site.data.info.address.building == "대전대학교" %}
        <i style="width: 1.5em;" class="fa fa-location-arrow"></i>08826 대전광역시 동구 대학로 62 1<BR>
        <i style="width: 1.5em;" class="fa fa-building"></i><a href="http://map.daum.net/?urlX=489601&urlY=1102659&itemId=26518818" target="_blank">대전대학교 융합과학관</a> {{ site.data.info.address.office }} (Office), {{ site.data.info.address.lab }} (Lab)<BR>
      {% else %}
